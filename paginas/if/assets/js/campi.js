let dados = [
    {
        url: '../../resultados/campi_inscritos_por_campus_com_sexo_if.json',
        elemento: 'inscritos_com_sexo',
        titulo: 'TOTAL DE INSCRITOS POR SEXO',
        multidaset: true
    },
    {
        url: '../../resultados/campi_maiores_menores_notas_corte_ampla_concorrencia_if.json',
        elemento: 'maior_menor_nota_ac',
        titulo: 'MAIOR E MENOR NOTA DE CORTE AC',
        multidaset: true
    },
    {
        url: '../../resultados/campi_maiores_menores_notas_corte_cota_if.json',
        elemento: 'maior_menor_nota_cotas',
        titulo: 'MAIOR E MENOR NOTA DE CORTE POR COTAS',
        multidaset: true
    },
    {
        url: '../../resultados/campi_quantidade_inscritos_if.json',
        elemento: 'inscritos',
        titulo: 'TOTAL DE INSCRITOS',
        multidaset: false
    },
    {
        url: '../../resultados/campi_quantidade_vagas_detalhada_if.json',
        elemento: 'vagas_detalhada',
        titulo: 'VAGAS DETALHADA',
        multidaset: true
    },
    {
        url: '../../resultados/campi_quantidade_vagas_if.json',
