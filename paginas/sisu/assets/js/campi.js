let dados = [
    {
        url: '../../resultados_sisu/campi_inscritos_por_campus_com_sexo_sisu.json',
        elemento: 'inscritos_com_sexo',
        titulo: 'TOTAL DE INSCRITOS POR SEXO',
        multidaset: true
    },
    {
        url: '../../resultados_sisu/campi_maiores_menores_notas_corte_ampla_concorrencia_sisu.json',
        elemento: 'maior_menor_nota_ac',
        titulo: 'MAIOR E MENOR NOTA DE CORTE AC',
        multidaset: true
    },
    {
        url: '../../resultados_sisu/campi_maiores_menores_notas_corte_cota_sisu.json',
        elemento: 'maior_menor_nota_cotas',
        titulo: 'MAIOR E MENOR NOTA DE CORTE POR COTAS',
        multidaset: true
    },
    {
        url: '../../resultados_sisu/campi_quantidade_inscritos_sisu.json',
        elemento: 'inscritos',
        titulo: 'TOTAL DE INSCRITOS',
        multidaset: false
    },
    {
        url: '../../resultados_sisu/campi_quantidade_vagas_detalhada_sisu.json',
        elemento: 'vagas_detalhada',
        titulo: 'VAGAS DETALHADA',
        multidaset: true
    },
    {
        url: '../../resultados_sisu/campi_quantidade_vagas_sisu.json',
        elemento: 'total_vagas',
        ...
        $.each(novo, function (i, v) {
            ...
            $.each(v.dados, function (a, b) {
                if (elemento === 'maior_menor_nota_cotas') {
                    ...
                    // config.data.datasets[i].label += ' - ' + Object.keys(b)[0];
                    config.data.datasets[i].data.push(Object.values(b)[0]);
