let dados = [
    {
        url: '../../resultados_sisu/curso_inscritos_com_sexo_sisu.json',
        elemento: 'inscritos_com_sexo',
        titulo: 'TOTAL DE INSCRITOS POR SEXO',
        multidaset: true
    },
    {
        url: '../../resultados_sisu/curso_inscritos_sisu.json',
        elemento: 'inscritos',
        titulo: 'TOTAL DE INSCRITOS',
        multidaset: false
    },
    {
        url: '../../resultados_sisu/curso_maiores_menores_notas_sisu.json',
        elemento: 'maior_menor_nota_ac',
        titulo: 'MAIOR E MENOR NOTA DE CORTE AC',
        multidaset: true
    },
    {
        url: '../../resultados_sisu/curso_notas_corte_ampla_concorrencia_sisu.json',
        elemento: 'notas_corte_ac',
        titulo: 'NOTAS DE CORTE PELA AMPLA CONCORRÊNCIA',
        multidaset: false
    },
    {
        url: '../../resultados_sisu/curso_notas_corte_cotas_sisu.json',
        elemento: 'nota_corte_cotas',
        titulo: 'NOTAS DE CORTE POR COTAS',
        multidaset: true
    },
    {
        url: '../../resultados_sisu/curso_vagas_sisu.json',
        elemento: 'vagas',
        titulo: 'VAGAS POR CURSO',
        multidaset: false
    },
    {
        url: '../../resultados_sisu/curso_vagas_por_cotas_detalhada_sisu.json',
        elemento: 'vagas_cotas_detalhada',
        titulo: 'VAGAS POR COTAS DETALHADA',
        multidaset: true
    },
    {
        url: '../../resultados_sisu/curso_vagas_por_cotas_sisu.json',
