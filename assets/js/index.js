let dados = [
    {
        url: 'resultados_gerais/geral_aglutinacao_area_conhecimento.json',
        elemento: 'area_conhecimento',
        titulo: 'Aglutinação por área de conhecimento',
        multidaset: false
    },
    {
        url: 'resultados_gerais/geral_por_processo.json',
        elemento: 'processo',
        titulo: 'Processo Seletivo',
        multidaset: false
    },
    {
        url: 'resultados_gerais/geral_por_sexo.json',
        elemento: 'geral_sexo',
        titulo: 'Inscritos Gerais por sexo',
        multidaset: false
    },
    {
        url: 'resultados_gerais/geral_por_vagas.json',
        elemento: 'geral_vagas',
        titulo: 'Vagas por Processo Seletivo',
        multidaset: false
    },
    {
        url: 'resultados_gerais/geral_vagas_por_campus.json',
        elemento: 'vagas_campus',
        titulo: 'Vagas por campus',
        multidaset: false
    },
    {
        url: 'resultados_gerais/geral_vagas_por_campus_detalhada.json',
        elemento: 'vagas_detalhadas',
        titulo: 'Vagas por campus detalhadas',
        multidaset: true
    }
];
